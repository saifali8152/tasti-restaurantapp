  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CustomerReservationsBloc, CustomerReservationsState>(
      builder: (context, state) {
        final isSelected = state.selectedRevervations.any((e) => e == data);
                  ...
                  Row(
                    ...
                    children: [
                      _buildStat(Icons.event_seat, "Reservations",
                          data.reservationCount.toString()),
                      _buildStat(
                          Icons.schedule, "Last Visit", data.lastReservationFormatted),
                      _buildStat(Icons.category, "Type", data.type),
                    ],
                  ),
